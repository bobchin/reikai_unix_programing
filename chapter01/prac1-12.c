...
void rect_print(struct rectangle *);
int rect_area(struct rectangle *);
void rect_move1(struct rectangle *, int, int);
struct rectangle rect_move2(struct rectangle, int, int);
int rect_is_overlapped(struct rectangle *, struct rectangle *);
...
{
  printf("point:(%d, %d) width:%d height:%d\n",
